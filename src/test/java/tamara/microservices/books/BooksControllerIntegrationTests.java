...
@SpringBootTest(classes = BooksConfiguration.class, properties = { "eureka.client.enabled=false" })
public class BooksControllerIntegrationTests extends AbstractBookControllerTests {
